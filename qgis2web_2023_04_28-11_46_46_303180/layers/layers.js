...
var format_water_centroid_15 = new ol.format.GeoJSON();
var features_water_centroid_15 = format_water_centroid_15.readFeatures(json_water_centroid_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_water_centroid_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_water_centroid_15.addFeatures(features_water_centroid_15);
var lyr_water_centroid_15 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_water_centroid_15, 
                style: style_water_centroid_15,
                interactive: true,
                title: '<img src="styles/legend/water_centroid_15.png" /> water_centroid'
            });
var format_water_buffer_16 = new ol.format.GeoJSON();
var features_water_buffer_16 = format_water_buffer_16.readFeatures(json_water_buffer_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_water_buffer_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_water_buffer_16.addFeatures(features_water_buffer_16);
var lyr_water_buffer_16 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_water_buffer_16, 
                style: style_water_buffer_16,
                interactive: true,
                title: '<img src="styles/legend/water_buffer_16.png" /> water_buffer'
            });
var format_malaria_17 = new ol.format.GeoJSON();
var features_malaria_17 = format_malaria_17.readFeatures(json_malaria_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_malaria_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_malaria_17.addFeatures(features_malaria_17);
var lyr_malaria_17 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_malaria_17, 
                style: style_malaria_17,
                interactive: true,
                title: '<img src="styles/legend/malaria_17.png" /> malaria'
            });
var format_housecentroids_18 = new ol.format.GeoJSON();
var features_housecentroids_18 = format_housecentroids_18.readFeatures(json_housecentroids_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_housecentroids_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_housecentroids_18.addFeatures(features_housecentroids_18);
var lyr_housecentroids_18 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_housecentroids_18, 
                style: style_housecentroids_18,
                interactive: true,
                title: '<img src="styles/legend/housecentroids_18.png" /> house-centroids'
            });
var format_governmentbodies_19 = new ol.format.GeoJSON();
var features_governmentbodies_19 = format_governmentbodies_19.readFeatures(json_governmentbodies_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_governmentbodies_19 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_governmentbodies_19.addFeatures(features_governmentbodies_19);
var lyr_governmentbodies_19 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_governmentbodies_19, 
                style: style_governmentbodies_19,
                interactive: true,
                title: 'governmentbodies'
            });
var format_govt_bodies_20 = new ol.format.GeoJSON();
var features_govt_bodies_20 = format_govt_bodies_20.readFeatures(json_govt_bodies_20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_govt_bodies_20 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_govt_bodies_20.addFeatures(features_govt_bodies_20);
var lyr_govt_bodies_20 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_govt_bodies_20, 
                style: style_govt_bodies_20,
                interactive: true,
                title: '<img src="styles/legend/govt_bodies_20.png" /> govt_bodies'
            });
var format_house_govt_21 = new ol.format.GeoJSON();
var features_house_govt_21 = format_house_govt_21.readFeatures(json_house_govt_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_house_govt_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_house_govt_21.addFeatures(features_house_govt_21);
var lyr_house_govt_21 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_house_govt_21, 
                style: style_house_govt_21,
                interactive: true,
                title: '<img src="styles/legend/house_govt_21.png" /> house_govt'
            });
var format_houselayer_22 = new ol.format.GeoJSON();
var features_houselayer_22 = format_houselayer_22.readFeatures(json_houselayer_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_houselayer_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_houselayer_22.addFeatures(features_houselayer_22);
var lyr_houselayer_22 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_houselayer_22, 
                style: style_houselayer_22,
                interactive: true,
                title: 'houselayer'
            });
var format_Houses_23 = new ol.format.GeoJSON();
var features_Houses_23 = format_Houses_23.readFeatures(json_Houses_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Houses_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Houses_23.addFeatures(features_Houses_23);
var lyr_Houses_23 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Houses_23, 
                style: style_Houses_23,
                interactive: true,
                title: '<img src="styles/legend/Houses_23.png" /> Houses'
            });

lyr_boundaryUntitledProject_0.setVisible(true);lyr_boundary_1.setVisible(true);lyr_Hospital_2.setVisible(true);lyr_roads_chain_3.setVisible(true);lyr_Hospital_4.setVisible(true);lyr_Roads_1_5.setVisible(true);lyr_schools_6.setVisible(true);lyr_Schools_7.setVisible(true);lyr_road_interpolation_8.setVisible(true);lyr_scl_hsptl_9.setVisible(true);lyr_Roads_10.setVisible(true);lyr_water_11.setVisible(true);lyr_buffer_malaria_12.setVisible(true);lyr_water_13.setVisible(true);lyr_OpenStreetMap_14.setVisible(true);lyr_water_centroid_15.setVisible(true);lyr_water_buffer_16.setVisible(true);lyr_malaria_17.setVisible(true);lyr_housecentroids_18.setVisible(true);lyr_governmentbodies_19.setVisible(true);lyr_govt_bodies_20.setVisible(true);lyr_house_govt_21.setVisible(true);lyr_houselayer_22.setVisible(true);lyr_Houses_23.setVisible(true);
var layersList = [lyr_boundaryUntitledProject_0,lyr_boundary_1,lyr_Hospital_2,lyr_roads_chain_3,lyr_Hospital_4,lyr_Roads_1_5,lyr_schools_6,lyr_Schools_7,lyr_road_interpolation_8,lyr_scl_hsptl_9,lyr_Roads_10,lyr_water_11,lyr_buffer_malaria_12,lyr_water_13,lyr_OpenStreetMap_14,lyr_water_centroid_15,lyr_water_buffer_16,lyr_malaria_17,lyr_housecentroids_18,lyr_governmentbodies_19,lyr_govt_bodies_20,lyr_house_govt_21,lyr_houselayer_22,lyr_Houses_23];
...
lyr_water_centroid_15.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_water_buffer_16.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_malaria_17.set('fieldAliases', {'id': 'id', 'temp': 'temp', 'cases': 'cases', 'spread': 'spread', 'x-coord': 'x-coord', 'y-coord': 'y-coord', });
lyr_housecentroids_18.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_governmentbodies_19.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_govt_bodies_20.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_house_govt_21.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'Name_2': 'Name_2', 'descript_1': 'descript_1', 'timestamp_': 'timestamp_', 'begin_2': 'begin_2', 'end_2': 'end_2', 'altitude_1': 'altitude_1', 'tessella_1': 'tessella_1', 'extrude_2': 'extrude_2', 'visibili_1': 'visibili_1', 'drawOrder_': 'drawOrder_', 'icon_2': 'icon_2', 'distance': 'distance', });
lyr_houselayer_22.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
lyr_Houses_23.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_water_centroid_15.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_water_buffer_16.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_malaria_17.set('fieldImages', {'id': 'TextEdit', 'temp': 'TextEdit', 'cases': 'TextEdit', 'spread': 'TextEdit', 'x-coord': '', 'y-coord': '', });
lyr_housecentroids_18.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_governmentbodies_19.set('fieldImages', {'Name': '', 'description': '', 'timestamp': '', 'begin': '', 'end': '', 'altitudeMode': '', 'tessellate': '', 'extrude': '', 'visibility': '', 'drawOrder': '', 'icon': '', });
lyr_govt_bodies_20.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
lyr_house_govt_21.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', 'Name_2': 'TextEdit', 'descript_1': 'TextEdit', 'timestamp_': 'TextEdit', 'begin_2': 'TextEdit', 'end_2': 'TextEdit', 'altitude_1': 'TextEdit', 'tessella_1': 'TextEdit', 'extrude_2': 'TextEdit', 'visibili_1': 'TextEdit', 'drawOrder_': 'TextEdit', 'icon_2': 'TextEdit', 'distance': 'TextEdit', });
lyr_houselayer_22.set('fieldImages', {'Name': '', 'description': '', 'timestamp': '', 'begin': '', 'end': '', 'altitudeMode': '', 'tessellate': '', 'extrude': '', 'visibility': '', 'drawOrder': '', 'icon': '', });
lyr_Houses_23.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', });
...
lyr_water_centroid_15.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_water_buffer_16.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_malaria_17.set('fieldLabels', {'id': 'no label', 'temp': 'no label', 'cases': 'no label', 'spread': 'no label', 'x-coord': 'no label', 'y-coord': 'no label', });
lyr_housecentroids_18.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_governmentbodies_19.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_govt_bodies_20.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_house_govt_21.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'Name_2': 'no label', 'descript_1': 'no label', 'timestamp_': 'no label', 'begin_2': 'no label', 'end_2': 'no label', 'altitude_1': 'no label', 'tessella_1': 'no label', 'extrude_2': 'no label', 'visibili_1': 'no label', 'drawOrder_': 'no label', 'icon_2': 'no label', 'distance': 'no label', });
lyr_houselayer_22.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_Houses_23.set('fieldLabels', {'Name': 'no label', 'descriptio': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMo': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
lyr_Houses_23.on('precompose', function(evt) {
